...
I am also involved in the development of the nexflow pipeline [nf-core/EAGER (v2)](https://github.com/nf-core/eager), which is intended to be a complete re-write of the NGS processing pipeline for ancient DNA data [EAGER (v1)](https://doi.org/10.1186/s13059-016-0918-z) 
